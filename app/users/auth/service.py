...
from app.users.user_profle.models import UserProfile
from app.users.user_profle.repository import UserRepository
from app.users.user_profle.schema import UserCreateSchema
...
class AuthService:
    ...
    async def google_auth(self, code: str):
        ...
        await self.user_cache.set_user_profile(created_user.id, create_user_data)
